...
type HealthCheckServiceClient interface {
	CheckGRPCConnection(ctx context.Context, in *HealthCheckResponse, opts ...grpc.CallOption) (*HealthCheckResponse, error)
}
...
func (c *healthCheckServiceClient) CheckGRPCConnection(ctx context.Context, in *HealthCheckResponse, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
type HealthCheckServiceServer interface {
	CheckGRPCConnection(context.Context, *HealthCheckResponse) (*HealthCheckResponse, error)
...
func (UnimplementedHealthCheckServiceServer) CheckGRPCConnection(context.Context, *HealthCheckResponse) (*HealthCheckResponse, error) {
...
func _HealthCheckService_CheckGRPCConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServiceServer).CheckGRPCConnection(ctx, req.(*HealthCheckResponse))
	}
